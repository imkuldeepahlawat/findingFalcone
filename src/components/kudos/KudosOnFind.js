...
export default function KudosOnFind() {
      ...
      <div className="kudos">
        <Box className="kudosbox">
          ...
          <h3 style={{ color: "white", fontSize: "20px" }}>
            Found on <span style={{ color: "#00987E" }}>{localStorage.getItem("planet_name")}</span>{" "}
            Time Taken:- <span style={{ color: "#00987E" }}>{localStorage.getItem("time")}</span>
          </h3>
  ...
  //         <Button variant="outlined">let the adventure begin!</Button>
  //       </Link>
  //     </Box>
  //   );
  // }
